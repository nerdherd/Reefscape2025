...
import frc.robot.subsystems.ElevatorPivotCopy;
...
public class SuperSystemCommand extends Command {
    private final ElevatorPivotCopy pivot;
    private final ElevatorCopy elevator;
    private final IntakeWristCopy wrist;
    ...
    public SuperSystemCommand(ElevatorPivotCopy pivot, ElevatorCopy elevator, IntakeWristCopy wrist,
