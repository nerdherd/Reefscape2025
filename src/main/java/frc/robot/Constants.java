...
public final class Constants {
 ...
 public static final class PivotConstants {
    ...
    public static final double kPivotCruiseVelocity = 0.6;//0.25 // 0.4S
    public static final double kPivotCruiseAcceleration = 0.6;//kPivotCruiseVelocity * 5; // 0.5
    public static final double kPivotJerk = 0.0;//kPivotCruiseAcceleration * 10;
  ...
  public static final class RollerConstants {
    ...
    public static final double kCoralSlowIntakePower = -1.5;
  ...
  public static final class WristConstants {
    ...
    public static final double kFMotor = 0.6; //Gravity
    public static final double kFOffset = 0.2973; //Gravity
  ...
  public static final class SuperSystemConstants {
    ...
    public enum CoralPositions { 
      ...
      GroundIntake(        ExecutionOrder.WRTELV_PVT  , 0.038, 0.81, -0.785), // warren testing
