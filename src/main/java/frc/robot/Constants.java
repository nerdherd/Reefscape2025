...
public final class Constants {
  ...
  public static final class IntakeConstants {
    ...
    public static final PrefDouble kWristStowPosition = new PrefDouble("Wrist Stow Position", 22);
    public static final PrefDouble kWristStationPosition = new PrefDouble("Wrist Station Position", 35);
